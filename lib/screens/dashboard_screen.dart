...
class _DashboardScreenState extends State<DashboardScreen>
            ...
            Expanded(
              child: Row(
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child: _buildPieChartLegend(sortedCategories),
                  ),
                ],
              ),
            ),
    ...
    return PieChart(
      PieChartData(
        sections: sortedCategories.asMap().entries.map((entry) {
          ...
          final percentage = _totalSpent > 0 ? (categoryEntry.value / _totalSpent * 100) : 0.0;
  ...
  Widget _buildTrendChart() {
    ...
    final spots = trendData.entries.toList().asMap().entries.map((entry) {
      final index = entry.key;
      ...
      LineChartData(
            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (double value, TitleMeta meta) {
                ...
                if (index >= 0 && index < trendData.length) {
                  final day = trendData.keys.toList()[index];
        ...
        lineTouchData: LineTouchData(
          touchTooltipData: LineTouchTooltipData(
            tooltipBgColor: const Color(0xFF667EEA),
